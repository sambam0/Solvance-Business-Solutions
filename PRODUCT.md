...
Three words: **precise, alive, credible**

Emotional goal: "These people clearly know what they're doing, and they built this site to prove it."

## Anti-references

- **Hustle/hype culture** — no "10x your revenue" energy, no emoji-heavy excitement, no influencer-adjacent tone
- **Big-agency corporate** — no IBM/Accenture formality, no committee-designed layouts, no impersonal copy
- **Generic AI-generated landing pages** — no hero-metric template, no floating feature cards on cream backgrounds, no section-eyebrow scaffolding
- **Freelancer portfolio aesthetic** — personal branding over business credibility

The site should be impossible to replicate by prompting a generic AI. Visitors should ask "how was this made?"
...
Best-effort baseline: sufficient contrast for body text, keyboard navigation functional, `prefers-reduced-motion` respected for all animations (already implemented with Framer Motion's `useReducedMotion`). Not targeting strict WCAG AA compliance; visual ambition is the priority where trade-offs arise.
