...
const secondaryBuilds = [
  {
    ...
    desc: 'Hands-on workshops and custom LLM setup that leave you and your team actually capable — not dependent on a vendor.',
    href: '/ai-training',
  },
  {
  ...
  },
  {
    ...
    desc: 'Senior AI engineer on call: architecture reviews, vendor decisions, and ad-hoc builds. $1,500/mo, no lock-in.',
  },
]
...
const NODE_LEGEND = [
  { id: 'hub',   color: '#3B9EFF', label: 'Mesh Hub',     desc: 'VPN routing & secure tunnels' },
  { id: 'cloud', color: '#9D6FFF', label: 'Cloud Node',   desc: 'Always-on intake & ops agents' },
  { id: 'local', color: '#34D399', label: 'Private Node', desc: 'Local AI & proprietary data' },
]
    ...
    <>
        ...
        <div className="wrap hero-wrap">
          <div className="hero-text">
            ...
            <motion.div className="ctas" {...fadeUp(0.44)}>
              ...
              <a href="#use-cases" className="btn ghost">
                See use cases
              </a>
            </motion.div>

            <motion.div className="hero-proof" {...fadeUp(0.56)}>
              <span>↳ 40+ agents shipped across legal, e-commerce, SaaS, and healthcare</span>
              <span>↳ 3 weeks to first measurable result — or we extend free</span>
            </motion.div>
          </div>

          <div className="hero-topo" aria-hidden="true">
            <svg viewBox="0 0 320 240" fill="none" xmlns="http://www.w3.org/2000/svg">
              <line x1="160" y1="44" x2="68" y2="196" stroke="#3B9EFF" strokeWidth="1" strokeDasharray="4 7" opacity="0.5" />
              <line x1="160" y1="44" x2="252" y2="196" stroke="#9D6FFF" strokeWidth="1" strokeDasharray="4 7" opacity="0.5" />
              <line x1="68" y1="196" x2="252" y2="196" stroke="#34D399" strokeWidth="1" strokeDasharray="4 7" opacity="0.5" />
              <circle cx="160" cy="44" r="16" fill="#0F1E36" />
              <circle cx="160" cy="44" r="16" stroke="#3B9EFF" strokeWidth="1.5" />
              <circle cx="68" cy="196" r="16" fill="#1A1030" />
              <circle cx="68" cy="196" r="16" stroke="#9D6FFF" strokeWidth="1.5" />
              <circle cx="252" cy="196" r="16" fill="#0A1A12" />
              <circle cx="252" cy="196" r="16" stroke="#34D399" strokeWidth="1.5" />
              <text x="160" y="28" textAnchor="middle" fill="#3B9EFF" fontSize="9" fontFamily="monospace" opacity="0.8">HUB</text>
              <text x="68" y="226" textAnchor="middle" fill="#9D6FFF" fontSize="9" fontFamily="monospace" opacity="0.8">CLOUD</text>
              <text x="252" y="226" textAnchor="middle" fill="#34D399" fontSize="9" fontFamily="monospace" opacity="0.8">LOCAL</text>
              ...
              <circle className="topo-traveler" r="3" fill="#34D399">
      ...
      <section id="what-we-build" ref={buildRef}>
        <div className="wrap">
          ...
          <FadeIn delay={0.1}><p className="section-sub">From a custom integration to a fully autonomous AI system — if your business needs it, we build it.</p></FadeIn>
              ...
              <SpringCard className="card cb-build-featured" hoverY={-4}>
                ...
                <div className="cb-mini-mesh" aria-hidden="true">
                  <svg viewBox="0 0 260 160" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <line x1="130" y1="26" x2="50" y2="134" stroke="#3B9EFF" strokeWidth="1.5" opacity="0.35" strokeDasharray="3 5" />
                    <line x1="130" y1="26" x2="210" y2="134" stroke="#9D6FFF" strokeWidth="1.5" opacity="0.35" strokeDasharray="3 5" />
                    <line x1="50" y1="134" x2="210" y2="134" stroke="#34D399" strokeWidth="1.5" opacity="0.35" strokeDasharray="3 5" />
                    <circle cx="130" cy="26" r="15" fill="#0F1E36" />
                    <circle cx="130" cy="26" r="15" stroke="#3B9EFF" strokeWidth="1.5" />
                    ...
                    <circle cx="50" cy="134" r="15" stroke="#9D6FFF" strokeWidth="1.5" />
                    <text x="50" y="138" textAnchor="middle" fill="#9D6FFF" fontSize="7" fontFamily="monospace" fontWeight="600">CLOUD</text>
                    <circle cx="210" cy="134" r="15" fill="#0A1A12" />
                    <circle cx="210" cy="134" r="15" stroke="#34D399" strokeWidth="1.5" />
                    <text x="210" y="138" textAnchor="middle" fill="#34D399" fontSize="7" fontFamily="monospace" fontWeight="600">LOCAL</text>
                    ...
                    <circle className="mini-mesh-traveler" r="3" fill="#34D399">
            ...
            <div className="cb-build-secondary">
              {secondaryBuilds.map((item, i) => (
                <div key={item.title} className="build-anim">
                  <SpringCard
                    className={`cb-build-item${i < secondaryBuilds.length - 1 ? ' cb-build-item-divided' : ''}`}
                    hoverY={-2}
                  >
        ...
        <div className="wrap">
          <FadeIn>
            <h2 className="section-title">
              A distributed mesh that routes<br />every task to the right agent.
            </h2>
          </FadeIn>
          <FadeIn delay={0.1}>
