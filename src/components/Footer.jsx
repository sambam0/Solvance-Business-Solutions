      ...
      <div className="wrap">
        <div className="footer-inner">
          <div className="footer-brand">
            <button className="brand nav-home-btn" onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })}>
              <span className="mk" />
              Solvance
            </button>
          ...
          <nav className="footer-nav" aria-label="Footer navigation">
            {siteLinks.map(l => (
              <button key={l.href} className="footer-nav-btn" onClick={() => scrollTo(l.href.slice(1))}>
                {l.label}
              </button>
            ))}
