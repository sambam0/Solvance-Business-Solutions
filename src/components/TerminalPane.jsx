...
const LINES = [
  { id: 'cmd',   type: 'command', text: "run-agent intake-qualifier --client \"Mara's Staffing\"" },
  ...
  { id: 'n3',    type: 'data',    text: '  Message:  "We\'re getting 40+ inbound calls/week and' },
  { id: 'n4',    type: 'data',    text: '             my team is drowning in manual follow-up..."' },
  { id: 'gap2',  type: 'gap',     text: '' },
  { id: 'class', type: 'meta',    text: '[12:47:04] Classifying lead...' },
  { id: 'v1',    type: 'success', text: '✓ ICP match: ops-overload / ready-to-automate  (confidence: 94%)' },
  { id: 'v2',    type: 'success', text: '✓ Slack DM → @sam  "High-priority lead. Daniel Reyes, Mara Staffing."' },
